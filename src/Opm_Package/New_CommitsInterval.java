...
public class New_CommitsInterval {
     ...
     */
     public Object[] getCommitsNow(String projectName, String date1, String date2, int i, String[] toks, String lastDate, long pl, long pc, long is, long ic, long ff ,int ct, int com_index ) throws org.json.simple.parser.ParseException, ParseException {
           ...
           if(com_index > 0){
        	...
        	if (ct == (toks.length) ){/// the the index for the tokens array...
                ...
                String jsonString = new Call_URL(). callURL("https://api.github.com/repos/"+projectName+"/commits?page="+p+"&per_page=100&since="+date1+"&until="+date2+"&access_token="+toks[ct++]);
